...
my %e_values = (
    ...
    12     => [ 100, 120, 150, 180, 220, 270, 330, 390,
                470, 560, 680, 820, ],
    24     => [ 100, 110, 120, 130, 150, 160, 180, 200,
...
foreach my $m (-2, -1, 0, 1, 2, 3, 4) {
    foreach my $e (@{$e_values{24}}, @{$e_values{96}}) {
        ...
        my $fh;
        open($fh, ">", "Vishay/CRCW0805${pn}FK");
        print $fh <<"EOT";
attr    footprint=R_0805.fp
attr    resistance=${ru}
attr    tolerance=±1%
attr    power-rating=0.125W
attr    temp-co=0±100ppm/°C
attr    case-style=axial
attr    case-length=2.0mm
attr    case-width=1.25mm
attr    case-width=0.55mm
attr    manuf=Vishay
attr    manuf-pn=CRCW0805${pn}FK
attr    mouser-pn=71-CRCW0805-${ru}-E3
EOT
        close($fh);
    }
}
