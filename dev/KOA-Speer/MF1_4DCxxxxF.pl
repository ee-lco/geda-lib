...
foreach my $m (-1, 0, 1, 2, 3, 4) {
    foreach my $e (@{$e_values{24}}, @{$e_values{96}}) {
        ...
        print $fh <<"EOT";
attr    footprint=R_AXIAL_400.fp
attr    resistance=${ru}
attr    tolerance=±1%
attr    power-rating=1/4W
attr    temp-co=0±100ppm/°C
attr    case-style=axial
attr    case-diameter=2.3mm
attr    case-length=7.1mm
attr    manuf=KOA Speer
attr    manuf-pn=MF1/4DC${pn}F
attr    mouser-pn=660-MF1/4DC${pn}F
EOT
        close($fh);
    }
}
